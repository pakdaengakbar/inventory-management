...
class MyHelper {
    ...
    public static function setBreadcrumb($setli1, $setli2, $urlli1 = '/home',$urlli2 = ''){
        return "<div class='py-3 d-flex align-items-sm-center flex-sm-row flex-column'>
                ...
                <div class='text-end'>
                    <ol class='breadcrumb m-0 py-0'>
                        <li class='breadcrumb-item'><a href='/".$urlli1.$urlli2."'>".$setli1."</a></li>
    ...
    public static function setRegionlivewire($field, $lifewire = false, $name=''){
        $region = MyService::getRegion();

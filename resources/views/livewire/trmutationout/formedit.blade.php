    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-end">
                    <a href="javascript:;" class="btn btn-sm btn-primary" title='print' onclick="printData('/inventory/mutout/print/');">
                        <i class="mdi mdi-printer-outline"></i> Print</a>
                    <a href="javascript:;" class="btn btn-success btn-sm" title="approved" onclick="updateStatus('/inventory/rwdata/moapproved', false);"  >
            ...
            <form class="form-horizontal"  method="POST" id="update-form" enctype="multipart/form-data">
                   ...
                   <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="cshipment" name="cshipment"  value="{{ $dtheader['cshipment'] }}" onkeyup="this.value=toUCase(this.value);" placeholder="Enter Shippment Number">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="cno_mutation" name="cno_mutation" value="{{ $dtheader['cno_mutation'] }}"
                                        placeholder="Enter Internal Order" readonly>
                                </div>
                                <label for="cstatus" class="col-sm-2 col-form-label text-center">Status</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control text-center" name="cstatus" id="cstatus"  value="{{ MyHelper::_getstatus('O') }}" placeholder="Status" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-select" name='nsrc_region'>
                                        @foreach ($region as $c)
                                            <option value="{{ $c->id }}" {{ $c->id == $dtheader['nsrc_region'] ? 'selected' : '' }}>{{ ucfirst($c->id.' - '.$c->cname) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-select" name='ndst_region' id = 'ndst_region'>
                                        ...
                                        @foreach ($region as $d)
                                            <option value="{{ $d->id }}" {{ $d->id == $dtheader['ndst_region'] ? 'selected' : '' }}>{{ ucfirst($d->id.' - '.$d->cname) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <div class="card-footer float-end">
                    <button type="button" onclick='update_data("/inventory/rwdata/moupdate", "/inventory/mutout");' id='btn-update2' class="btn btn-primary btn-sm waves-effect waves-light">

            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3"> 
                                <label for="ncompanyid" class="form-label">Company</label>
                            ...
                            <div class="mb-3"> 
                                ...
                                <input type="text" name="cname" class="form-control @error('cname') is-invalid @enderror"  placeholder="Branch Name"  onkeyup="this.value=toUCword(this.value);" wire:model="cname">
                                @error('cname')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>

                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control bg-light" id="cno_faktur" name="cno_faktur" value="{{ $dtheader['cno_faktur'] }}" placeholder="Enter Internal Order" readonly>
                                </div>
                                <label for="cstatus" class="col-sm-2 col-form-label text-center">Status</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control text-center bg-light" name="cstatus"  value="{{ MyHelper::_getstatus($dtheader['cstatus']) }}"  placeholder="Status" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="ccustomer_name" name="ccustomer_name" onkeydown="findCustomerEvent(event)"
                                                           placeholder="Enter Customer"  value="{{ $dtheader['ccustomer_name'] }}" onkeyup="this.value=toUCword(this.value);">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control text-center bg-light" value="{{ $dtheader['ncustomer_id'] }}" id="ncustomer_id" name="ncustomer_id" placeholder="Customer" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="row mb-3 justify-content-end">
                                ...
                                <div class="col-sm-6">
                                    <input readonly type="text" class="form-control text-end bg-light" name="ntot_ppn" id="ntot_ppn"  value="{{ number_format($dtheader['nsub_total']) }}"  placeholder="Total PPN">
                                </div>
                            </div>
                            <div class="row mb-3 justify-content-end">
                            ...
                            <div class="row mb-3 justify-content-end">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control text-end" name="npayment" id="npayment" onkeyup="calculatePay(this);" value="{{ number_format($dtheader['npayment']) }}" placeholder="Payment" >
                                </div>
                            </div>
                            <div class="row mb-3 justify-content-end">
                                <label for="ntotal" class="col-sm-4 col-form-label text-end">Remaining Change </label>
                                <div class="col-sm-6">
                                    <input readonly type="text" class="form-control text-end bg-light" name="nremaining" id="nremaining" value="{{ number_format($dtheader['nremaining']) }}" placeholder="Remaining" >
                                </div>
                            </div>
                        </div>
                    </div>
